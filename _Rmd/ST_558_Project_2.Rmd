...
Once seeing the correlation table and graph, it is possible to graph two variables on a scatterplot. This provides a visual of the linear relationship. A scatterplot of two variables in the `params$DataChannel` dataset has been created above.

```{r contingency tables }

## DELETe## should i delete these and do differnt contigency tables since you did a better version of this with every day of the week? 
